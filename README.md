...
The aim of this website is to create a modern visual presence online for a new community based project ‘Corca Dhuibhne Community Woodlands’. The goal is to create awareness of the overall project itself and to get people involved, in some way.
...
- - -
 - *Strategy Plane*:  Create a feel-good visually appealing custom website with calls to action to engage the public to become involved in the project as either active or passive participants. Create the impression of lush greenery and vitality.
...
- - -
 - *Skeleton Plane*:  Top priority is awareness about the aims of the project, using visual imagery, evoking the charms of native woodlands.
...
2. [YouTube Tutorials](https://www.youtube.com tutorials):
    - mmtuts
    - Traversy Media
    - Academind
*Github and Gitpod tutorials*:
1. [Code Institute](https://codeinstitute.net)
2. Various via [Google](https://www.youtube.com)
